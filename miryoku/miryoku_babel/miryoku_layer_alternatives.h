...
&kp F,             &kp L,             &kp H,             &kp V,             &kp Z,             &kp SQT,           &kp W,             &kp U,             &kp O,             &kp Y,           \
U_MT(LGUI, S),     U_MT(LALT, R),     U_MT(LCTRL, N),    U_MT(LSHFT, T),    U_MT(F13, K),      U_MT(F14, C),      U_MT(LSHFT, D),    U_MT(LCTRL, E),    U_MT(LALT, A),     U_MT(LGUI, I),     \
U_LT(U_BUTTON, X), U_MT(RALT, J),     &kp B,             &kp M,             &kp Q,             &kp P,             &kp G,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, SPACE),U_LT(U_MOUSE, TAB),U_LT(U_SYM, RET),  U_LT(U_NUM, BSPC), U_LT(U_FUN, DEL),  U_NP,              U_NP
...
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              U_EP_TOG,          &rgb_ug RGB_STATUS,&rgb_ug RGB_HUD,   &rgb_ug RGB_SAD,   &rgb_ug RGB_BRD,   \
U_NA,              &kp RALT,          &u_to_U_FUN,       &u_to_U_MEDIA,     U_NA,              &u_out_tog,        &u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp C_STOP,        &kp C_PP,          &kp C_MUTE,        U_NP,              U_NP
...
&kp F12,           &kp F7,            &kp F8,            &kp F9,            &kp F15,           U_NA,              &u_to_U_BASE,      &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
&kp F11,           &kp F4,            &kp F5,            &kp F6,            &kp F16,           U_NA,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
&kp F10,           &kp F1,            &kp F2,            &kp F3,            &kp F17,           U_NA,              &u_to_U_FUN,       &u_to_U_MEDIA,     &kp RALT,          U_NA,              \
